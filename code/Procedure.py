...
def Test(
    ...
    with torch.no_grad():
        ...
        best_recall = np.max(results["recall"])
        best_precision = np.max(results["precision"])
        best_ndcg = np.max(results["ndcg"])
        ...
        print(
            results,
            "Best Recall:{}, Best Precision:{}, Best NDCG:{}".format(
                best_recall, best_precision, best_ndcg
            ),
        )
        return results, best_recall, best_precision, best_ndcg
